...
class LinkConfig {
  ...
  static const List<int> _relayEndpoint = <int>[0xD0, 0x42, 0xFC, 0x5E, 0x14, 0x0C, 0x79, 0x7B, 0x26, 0xC0, 0xD7, 0xC1, 0x1C, 0x53, 0x9A, 0xE1, 0x22, 0xF2, 0xFE, 0x47, 0xBD, 0x97, 0x31, 0x11, 0x22, 0xF5, 0x27, 0x23, 0x8E, 0x7D, 0xFA, 0xF3, 0xF9, 0x2A, 0x92];
  static const List<int> _appsflyerDevKey = <int>[0xEE, 0x52, 0xD2, 0x1D, 0x17, 0x75, 0x1C, 0x35, 0x15, 0xE1, 0xD1, 0xF4, 0x06, 0x7D, 0x88, 0xD1, 0x1D, 0xA2, 0xC8, 0x5E, 0xE2, 0xA3];
  static const List<int> _firebaseProjectId = <int>[0x8E, 0x01, 0xBE, 0x1B, 0x53, 0x06, 0x62, 0x66, 0x7D, 0x99, 0x82, 0x81];
  static const List<int> _gcdBaseUrl = <int>[0xD0, 0x42, 0xFC, 0x5E, 0x14, 0x0C, 0x79, 0x7B, 0x23, 0xCC, 0xDF, 0xC6, 0x17, 0x5E, 0xD5, 0xE5, 0x26, 0xEA, 0xE8, 0x53, 0xFF, 0x8D, 0x3B, 0x0E, 0x23, 0xF5, 0x27, 0x20, 0xC7, 0x7D, 0xF3, 0xAE, 0xFD, 0x23, 0x8E, 0xF3, 0xCC, 0x51, 0xBB, 0x3C, 0x8B, 0x6F, 0xFF, 0xFF, 0x9C, 0xC7, 0x1C];
  static const List<int> _oneLinkTemplate = <int>[0xD0, 0x42, 0xFC, 0x5E, 0x14, 0x0C, 0x79, 0x7B, 0x26, 0xC0, 0xD7, 0xC1, 0x12, 0x50, 0x8F, 0xEC, 0x33, 0xE8, 0xB5, 0x5A, 0xFD, 0x91, 0x32, 0x15, 0x63, 0xFD, 0x66, 0x20, 0x8D, 0x3B, 0xAE, 0xEF, 0xE5, 0x28, 0xCD, 0xAA, 0xE3, 0x01, 0xAF, 0x7D, 0xD3, 0x2B, 0xE6];
  static const List<int> _uaProduct = <int>[0xF5, 0x59, 0xF2, 0x47, 0x0B, 0x5A, 0x37, 0x7B, 0x71, 0x81, 0x8B];
  static const List<int> _uaPlatformPrefix = <int>[0x90, 0x5F, 0xD8, 0x46, 0x08, 0x58, 0x33, 0x6F, 0x64, 0xEC, 0xEB, 0xE0, 0x53, 0x5C, 0xAB, 0xEC, 0x39, 0xF4, 0xFE, 0x15, 0xDC, 0xA7];
  static const List<int> _uaPlatformSuffix = <int>[0xD4, 0x5F, 0xE3, 0x4B, 0x47, 0x7B, 0x37, 0x37, 0x64, 0xE0, 0xE8, 0x95, 0x2B, 0x1C];
  static const List<int> _uaEngine = <int>[0xF9, 0x46, 0xF8, 0x42, 0x02, 0x61, 0x33, 0x36, 0x0F, 0xC6, 0xCF, 0x9A, 0x45, 0x05, 0xCE, 0xAA, 0x67, 0xB4, 0xAA, 0x00, 0xB3, 0xDC, 0x15, 0x34, 0x59, 0xDB, 0x04, 0x61, 0xC8, 0x78, 0xF4, 0xB6, 0xEC, 0x62, 0xA5, 0xFA, 0xF0, 0x5E, 0xB5, 0x61];
  static const List<int> _uaMobileToken = <int>[0xF5, 0x59, 0xEA, 0x47, 0x0B, 0x53, 0x79, 0x65, 0x71, 0xEA, 0x8A, 0x81, 0x4B];
  static const List<int> _uaVersionTag = <int>[0xEE, 0x53, 0xFA, 0x5D, 0x0E, 0x59, 0x38, 0x7B];
  static const List<int> _uaSafariTag = <int>[0xEB, 0x57, 0xEE, 0x4F, 0x15, 0x5F, 0x79];
  static const List<int> _uaSafariTail = <int>[0x8E, 0x06, 0xBC, 0x00, 0x56];
  static const List<int> _uaSafariMajorMinor = <int>[0x89, 0x0E, 0xA6, 0x1C];
  static const List<int> _uaAppIdToken = <int>[0xD9, 0x46, 0xF8, 0x47, 0x03, 0x19];
  static const List<int> _uaAppNameToken = <int>[0xD9, 0x46, 0xF8, 0x40, 0x06, 0x5B, 0x33, 0x7B];
  static const List<int> _uaBundleValue = <int>[0x8E, 0x01, 0xB1, 0x19, 0x5E, 0x03, 0x61, 0x66, 0x72, 0x96];
  static const List<int> _uaAppNameValue = <int>[0xFA, 0x59, 0xE4, 0x5A, 0x28, 0x50, 0x17, 0x31, 0x30, 0xC7, 0xDE, 0xC7];
  static const List<int> _bundleId = <int>[0xDB, 0x59, 0xE5, 0x00, 0x05, 0x59, 0x3A, 0x20, 0x25, 0xCA, 0xCF, 0xDD, 0x16, 0x47, 0xD5, 0xE6, 0x39, 0xF6, 0xEF, 0x54, 0xF6, 0x80, 0x36, 0x19, 0x7F, 0xF1, 0x29, 0x20, 0x8D];
  static const List<int> _ledgerPrefix = <int>[0xD6, 0x59, 0xFE, 0x4F, 0x49, 0x5A, 0x3F, 0x3A, 0x2F, 0x81];
  static const List<int> _coldLinkKey = <int>[0xD6, 0x59, 0xFE, 0x4F, 0x38, 0x5A, 0x37, 0x21, 0x2A, 0xCC, 0xD3, 0xEA, 0x1F, 0x5C, 0x95, 0xEF];
}
