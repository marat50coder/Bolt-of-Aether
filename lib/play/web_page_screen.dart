...
class _WebPageScreenState extends State<WebPageScreen> {
  ...
  void _openDocument(WebViewController controller) {
    final asset = widget.assetPath;
    if (asset != null && asset.isNotEmpty) {
      controller.loadFlutterAsset(asset);
      return;
    }
    ...
    return PopScope(
      ...
      child: Scaffold(
        ...
        body: _failed || controller == null
            ? _OfflineState(url: widget.url ?? widget.assetPath ?? '', error: _error, onRetry: _reload)
          ...
          child: GlassPanel(
            ...
            child: Column(
              ...
              children: [
                ...
                SelectableText(
                  url.isEmpty ? 'Local document' : url,
                  textAlign: TextAlign.center,
