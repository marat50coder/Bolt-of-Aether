...
// calling `FirebaseApp.configure()` before plugin registration — breaks
// the delivery chain (tapped pushes silently never reach Dart).
//
...
// before the Dart side asks for permission via `push.askPermission`.
